import { FragmentType } from "./types.js";
declare global {
    namespace JSX {
        ...
        type TargetedSecurityPolicyViolationEvent<Target extends EventTarget> = TargetedEvent<Target, SecurityPolicyViolationEvent>;
        ...
        type SecurityPolicyViolationEventHandler<Target extends EventTarget> = EventHandler<TargetedSecurityPolicyViolationEvent<Target>>;
        ...
        interface IntrinsicElements extends IntrinsicElementsType {
        }
        interface Element {
